...
goog.exportSymbol('proto.todos.TodoChange', null, global);
goog.exportSymbol('proto.todos.TodoChangeType', null, global);
 ...
 * @constructor
 */
proto.todos.TodoChange = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.todos.TodoChange, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.todos.TodoChange.displayName = 'proto.todos.TodoChange';
}
 ...
 * @return {!Object}
 */
proto.todos.TodoChange.prototype.toObject = function(opt_includeInstance) {
  return proto.todos.TodoChange.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.todos.TodoChange} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.todos.TodoChange.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.todos.TodoChange}
 */
proto.todos.TodoChange.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.todos.TodoChange;
  return proto.todos.TodoChange.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.todos.TodoChange} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.todos.TodoChange}
 */
proto.todos.TodoChange.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = /** @type {!proto.todos.TodoChangeType} */ (reader.readEnum());
      msg.setType(value);
      break;
    case 2:
      var value = new proto.todos.Todo;
 ...
 * @return {!Uint8Array}
 */
proto.todos.TodoChange.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.todos.TodoChange.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.todos.TodoChange} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.todos.TodoChange.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getType();
  if (f !== 0.0) {
    writer.writeEnum(
...
/**
 * optional TodoChangeType type = 1;
 * @return {!proto.todos.TodoChangeType}
 */
proto.todos.TodoChange.prototype.getType = function() {
  return /** @type {!proto.todos.TodoChangeType} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/**
 * @param {!proto.todos.TodoChangeType} value
 * @return {!proto.todos.TodoChange} returns this
 */
proto.todos.TodoChange.prototype.setType = function(value) {
 ...
 * @return {?proto.todos.Todo}
 */
proto.todos.TodoChange.prototype.getTodo = function() {
  return /** @type{?proto.todos.Todo} */ (
    jspb.Message.getWrapperField(this, proto.todos.Todo, 2));
};
 ...
 * @return {!proto.todos.TodoChange} returns this
*/
proto.todos.TodoChange.prototype.setTodo = function(value) {
 ...
 * @return {!proto.todos.TodoChange} returns this
 */
proto.todos.TodoChange.prototype.clearTodo = function() {
 ...
 * @return {boolean}
 */
proto.todos.TodoChange.prototype.hasTodo = function() {
