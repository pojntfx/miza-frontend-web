...
type TodosSubscribeToChanges = {
  readonly methodName: string;
  readonly service: typeof Todos;
  readonly requestStream: false;
  readonly responseStream: true;
  readonly requestType: typeof google_protobuf_empty_pb.Empty;
  readonly responseType: typeof src_proto_todos_pb.TodoChange;
};
...
export class Todos {
  ...
  static readonly SubscribeToChanges: TodosSubscribeToChanges;
}
...
export class TodosClient {
  ...
  subscribeToChanges(requestMessage: google_protobuf_empty_pb.Empty, metadata?: grpc.Metadata): ResponseStream<src_proto_todos_pb.TodoChange>;
}
