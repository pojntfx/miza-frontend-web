...
var api_todos_pb = require("../api/todos_pb");
...
Todos.Create = {
  ...
  requestType: api_todos_pb.NewTodo,
...
Todos.List = {
  ...
  responseType: api_todos_pb.TodoList
};
...
Todos.Get = {
  ...
  requestStream: false,
  responseStream: false,
  requestType: api_todos_pb.TodoID,
  responseType: api_todos_pb.Todo
};
